...
public partial class MainMenu : UserControl, IChildable
{
    ...
    private readonly LoadTimeManager _loadTimeManager;

    public IParentable ParentElement { get; private set; }

    private Control _affairsManager = null!;
    private Control _profileManager = null!;
    private Control _settingsManager = null!;
    private Control _hotkeySettingsManager = null!;
