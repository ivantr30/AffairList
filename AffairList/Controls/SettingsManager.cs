...
public partial class SettingsManager : UserControl, IChildable
{
    ...
    private Settings _newSettings = null!;
    ...
    public SettingsManager(Settings settings, IParentable parentElement)
    {
        ...
        _globalTogglerX = _settings.GetAutostart() ? autostartStateLab.Left - 14 : autostartStateLab.Left;
    }
    private void LoadSettings()
    {
        ...
        if (_settings.GetCanBeAlwaysReplaced())
        {
    ...
    {
        _newSettings.SetAutostart(!_newSettings.GetAutostart(), false);
        autostartStateLab.Text = _newSettings.GetAutostart() ? "On" : "OFF";
        autostartStateLab.Left = _newSettings.GetAutostart() ? _globalTogglerX : _globalTogglerX - 8;
    }
    ...
    {
        _newSettings.SetAskToDelete(!_newSettings.GetAskToDelete());
        AskToDeleteState.Text = _newSettings.GetAskToDelete() ? "On" : "OFF";
        AskToDeleteState.Left = _newSettings.GetAskToDelete() ? _globalTogglerX : _globalTogglerX - 8;
    }
    ...
    {
        _newSettings.SetDoesNotificate(!_newSettings.DoesNotificate());
    ...
    {
        _newSettings.SetCanBeAlwaysReplaced(!_newSettings.GetCanBeAlwaysReplaced());
        CanBeAlwaysReplacable.Text = _newSettings.GetCanBeAlwaysReplaced() ? "On" : "OFF";
        CanBeAlwaysReplacable.Left = _newSettings.GetCanBeAlwaysReplaced() ? _globalTogglerX : _globalTogglerX - 8;
    }
